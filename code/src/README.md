...
Best way to build the whole project is to use _Visual Studio 2017 Community_. Thereafter, download the complete sources, open the project file ``Plexdata.CsvParser.NET.csproj``, switch to release and rebuild all.
